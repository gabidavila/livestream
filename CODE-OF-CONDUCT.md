...
Some Google open source projects [may adopt](https://opensource.google/docs/releasing/preparing/#conduct) an explicit project code of conduct, which may have additional detailed expectations for participants. Most of those projects will use our [modified Contributor Covenant](https://opensource.google/docs/releasing/template/CODE_OF_CONDUCT/).
...
*This document was adapted from the [IndieWeb Code of Conduct](https://indieweb.org/code-of-conduct) and can also
